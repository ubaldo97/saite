...
class SSServiceReq {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const update = yield ua_1.default.findOneAndUpdate({ licenciatura: -2 }, { $set: { requisitos: reqsModificados } });
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const update = yield ua_1.default.findOneAndUpdate({ licenciatura: -2 }, { $set: { requisitos: reqs } });
            res.send((update) ? true : false);
        });
    }
    delete(req, res) {
