...
class SSServiceFechas{
    ...
    private async create(req: Request, res: Response){
        ...
        const update = await PE.findOneAndUpdate({licenciatura: -2},{$set: {fechas: fechasModificadas}});
    ...
    private async update(req: Request, res: Response){
        ...
        const update = await PE.findOneAndUpdate({licenciatura: -2},{$set: {fechas: dates}});
...
export default ssServiceFechas.router;