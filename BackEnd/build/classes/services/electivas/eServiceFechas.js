...
class EServiceFechas {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const update = yield ua_1.default.findOneAndUpdate({ licenciatura: -1 }, { $set: { fechas: fechasModificadas } });
            const updateMany = yield ua_1.default.updateMany({ periodo: 'electiva' }, { fechas: fechasModificadas });
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const update = yield ua_1.default.findOneAndUpdate({ licenciatura: -1 }, { $set: { fechas: dates } });
            const updateMany = yield ua_1.default.updateMany({ periodo: 'electiva' }, { fechas: dates });
            res.send((update) ? true : false);
        });
    }
    delete(req, res) {
